...
const CHAT_MESSAGE_TABLE = 'teraworkChatMessageTable';
  ...
  module.exports.getMessages = async(conversationId) => {  
    const params = {
      ...
      IndexName: "filter-messages-by-conversationId",
      KeyConditionExpression: 'conversationId = :rkey',
  ...
  module.exports.sendPeerMessage = async(payload) => {
    const id = uuidv4();
